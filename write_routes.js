const fs=require('fs');
const routes='d:/Desktop/WDP/WDP301/backend/routes';
...
fs.writeFileSync(routes + '/topics.js', topics);
fs.writeFileSync(routes + '/subtopics.js', subtopics);
fs.writeFileSync(routes + '/labelsets.js', labelsets);
console.log('OK:' + topics.length + ':' + subtopics.length + ':' + labelsets.length);
