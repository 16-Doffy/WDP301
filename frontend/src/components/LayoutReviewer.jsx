      ...
      <aside className="w-64 bg-gray-900 border-r border-gray-800 flex flex-col shrink-0">
        ...
        <div className="border-t border-gray-800 p-3">
          <div className="mb-3 flex items-center gap-3 rounded-lg border border-gray-800 bg-gray-900 p-2">
            <div className="flex h-10 w-10 items-center justify-center rounded-full bg-violet-600 border border-gray-700">
            ...
            <div className="min-w-0">
              ...
              <p className="truncate text-xs text-gray-400">Reviewer</p>
            </div>
          </div>
          <button
