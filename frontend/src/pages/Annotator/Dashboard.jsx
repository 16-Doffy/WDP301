      ...
      {filteredBatches.length === 0 ? (
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-12 text-center">
          <p className="text-gray-600 mb-4">
            {searchTerm ? 'No batches found matching your search.' : 'Bạn chưa có batches nào được phân công. Vui lòng liên hệ Manager để được phân công tasks.'}
          </p>
          {!searchTerm && (
            <button
          ...
          {filteredBatches.map((batch) => {
            ...
            return (
              <div
                ...
                onClick={() => {
                  // Navigate to first task in batch
                  if (firstTask) {
