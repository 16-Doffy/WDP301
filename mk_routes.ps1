$d = "d:/Desktop/WDP/WDP301/backend/routes"
$t = @"
...
[System.IO.File]::WriteAllText("$d/topics.js", $t, [System.Text.Encoding]::UTF8)
[System.IO.File]::WriteAllText("$d/subtopics.js", $s, [System.Text.Encoding]::UTF8)
[System.IO.File]::WriteAllText("$d/labelsets.js", $l, [System.Text.Encoding]::UTF8)
Write-Output "All routes created"
