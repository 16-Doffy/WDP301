const fs = require('fs');
const f = 'c:/Users/PC/Downloads/wdp/WDP301/backend/routes/reviews.js';
...
`;
const nc = c.replace('module.exports = router;', patch + 'module.exports = router;');
fs.writeFileSync(f, nc, 'utf8');
console.log('Done: ' + nc.length + ' bytes');